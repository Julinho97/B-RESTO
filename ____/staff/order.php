<?php
  ...
  if($_SESSION['user_role'] != "Mesero"){
    echo ("<script>window.alert('Solo meseros disponibles!'); window.location.href='order.php';</script>");
    exit();
  }
...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Bamsasin Resto</a>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card mb-3">
                ...
                Quantité : <input id="qty" required="required" type="number" min="1" max="50" name="qty" value="1" />
        					<button class="btn btn-info" onclick = "insertItem()">Envoyer</button>
        					<br><br>
				</div>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                    <form action="insertorder.php" method="POST">
						...
						<input class="btn btn-success" type="submit" name="sentorder" value="Envoyer">
					</form>
                </div>
              </div>
            </div>
