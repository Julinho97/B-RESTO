      ...
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          <form id="loginform">
            ...
            <input type="submit" class="btn btn-primary btn-block" form="loginform" name="btnlogin" value="Connecte" />
          </form>
		  <a href="../index.php" class="btn btn-primary btn-block">Back To Bord</a>
        </div>
      </div>
    </div>
	</div>
